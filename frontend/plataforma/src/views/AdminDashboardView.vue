...
import DashboardFilters  from '../components/organisms/Employe/DashboardFilters.vue'
import InventoryTable    from '../components/organisms/Employe/InventoryTable.vue'
import RealtimeOrders    from '../components/organisms/Employe/RealTimeOrders (1).vue'
