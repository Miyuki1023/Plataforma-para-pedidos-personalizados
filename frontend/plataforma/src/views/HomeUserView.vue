...
.feature-title { font-weight: 700; font-size: 0.88rem; color: var(--text-h); margin: 0 0 0.2rem; }
.feature-desc  { font-size: 0.78rem; color: var(--text); margin: 0; line-height: 1.4; }
...
/* ── Promos ── */
.promos-section { background: var(--soft-bg); }
...
.diff-item-title { font-weight: 700; font-size: 0.88rem; color: var(--text-h); margin: 0 0 0.15rem; text-align: left;}
.diff-item-desc  { font-size: 0.78rem; color: var(--text); margin: 0; text-align: left;}
...
.dot.active { background: var(--accent); width: 32px; }
...
@media (max-width: 600px) {
  ...
  .categories-left { margin: 0 0 1rem 1rem; }
  .chips-row { margin: 0; padding: 0 1.5rem; width: 100%; }
}
</style>