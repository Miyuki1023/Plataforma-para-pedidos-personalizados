...
import EmployeeSidebar from '../components/organisms/Employe/EmployeeSidebar.vue'
import AppTopBar from '../components/organisms/Employe/AppTopBar.vue'
import OrderStatCard from '../components/molecules/Employee/OrderStatCard.vue'
import MiniCalendar from '../components/molecules/Employee/MiniCalendar.vue'
import OrderRow from '../components/molecules/Employee/OrderRow.vue'
import OrderDetailModal from '../components/organisms/Employe/OrderDetailModal.vue'
...
async function fetchOrders() {
  ...
  try {
    ...
    if (selectedStatus.value !== 'all') {
      query.append('estado_pedido', selectedStatus.value)
    }
    if (selectedDate.value) {
      query.append('fecha_inicio', selectedDate.value)
      query.append('fecha_fin', selectedDate.value)
    }
