  ...
  <section class="favorites-section">
    ...
    >
      ...
      <ProductCard
        ...
        :key="fav.id"
        :id="fav.id || fav.id_producto || fav.id_promocion"
        :image="fav.image || fav.imageUrl || fav.imagen_url || fav.foto || ''"
        ...
        :price="Number(fav.price || fav.precio || fav.precio_promocion || fav.monto || 0)"
      />
